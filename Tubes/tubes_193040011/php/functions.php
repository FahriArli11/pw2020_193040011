...
function koneksi()
{
  $conn = mysqli_connect("http://193040011.pw.if.unpas.ac.id/", "pw19011", "#Akun#193040011#") or die("koneksi ke DB gagal");
  mysqli_select_db($conn, "pw19011_tubes_193040011") or die("Database Salah!");
